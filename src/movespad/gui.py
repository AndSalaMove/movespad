...
def gui():
    ...
    layout = [
        ...
        [sg.T("Focal length (mm)", size=(20,1), justification='right'),  sg.I(key='f_lens', default_text='5', size=(10,1)),
        sg.T("Bkg irradiance (W/m2)", size=(20,1), justification='right'), sg.I(key="bkg_power", default_text="0.2", size=(10,1))],
        [sg.T("Lens diameter (mm)", size=(20,1), justification='right'), sg.I(key='d_lens', default_text='6', size=(10,1)),
